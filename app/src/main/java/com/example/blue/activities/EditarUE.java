...
public class EditarUE extends AppCompatActivity {

    TextView Nombre, PrimerApellido, SegundoApellido, Usuario, Correo, Tel, Profesion, Cedula;
    Button btnRegistro;
    String id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_editar_ue);
        ...
        Profesion.setText(getIntent().getStringExtra("profesion"));
        ...
        btnRegistro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        ||Tel.getText().toString().isEmpty())
                {
                    ...
                    RegistroE(Constants.IP_ADDRESS +"EditarUE.php");
                }
            }
        });
    }
    ...
    private void RegistroE(String URL)
    {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("profesion", Profesion.getText().toString().trim());
